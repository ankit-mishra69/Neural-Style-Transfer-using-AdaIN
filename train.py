...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str,
                        default='C:/Users/Welcome/Desktop/NST_CODE/content_data',
                        help='Location of content dataset')

    parser.add_argument('--style_dir', type=str,
                        default='C:/Users/Welcome/Desktop/NST_CODE/style_data',
                        help='Location of style dataset')

    parser.add_argument('--vgg', type=str,
                        default='C:/Users/Welcome/Desktop/NST_CODE/vgg_norma/vgg_normalised.pth',
